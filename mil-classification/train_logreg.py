        ...
        for i in range(len(slide_predicted_argmax)):
            if discriminativePatchFinder is not None:
                if discriminativePatchFinder.useDuringPredict():
                    ...
                    H, _ = discriminativePatchFinder.filterDiscriminativePatches(np.asarray(slide_per_class_probabilities[i]),
                    ...
                    model_slide_per_class_probabilities.append(np.delete(np.asarray(slide_per_class_probabilities[i], indices_to_ignore)))
