...
def simple_training():
    ...
    runName = "lymphoma_simple_180910/"
...
def em_training():
    ...
    train_em.emtrain(trainSlideData, testSlideData,
                     ...
                     do_augment=True,
                     num_epochs=trainepochs, dropout_ratio=DROPOUT_RATIO, learning_rate=LEARNING_RATE, sanity_check=False,
                     logfile_path=logfile_path, logreg_savepath=logreg_savepath, runName=runName,
                     netAcc=None,
                     buildNet = lnet.getLymphNet,
                     valIsTestData=True)
